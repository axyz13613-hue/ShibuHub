...
version.Text="v2.0.2 • Monster Auto Feed"
version.ZIndex=5002
version.Parent=card
...
local SOURCE = [======[
--[[
    ShiBuHub v2.0.2 • LOADING FIX + MONSTER AUTO FEED
...
local hl=textLabel(homeCard,"ShiBuHub v2.0.2",22,true)
...
whTest.MouseButton1Click:Connect(function()
    ...
    local ok,why=sendWebhook("ShiBuHub connected","Webhook test from ShiBuHub v2.0.2")
